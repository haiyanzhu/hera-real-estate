...
function Contact () {
    return(
        <div className="contactdiv">
            ...
            <h2 className="h2name">Get in Touch with Hera's Dream Dwellings</h2>
            </div>
        
        <div className="divItem">
            <h3 className="h3head">
            <span className="title">Address:</span></h3>
            <p>123 Dream Home Street,
Cityville, State, Zip Code</p>
        </div>
        <div className="divItem">
            <h3 className="h3head"> <span className="title">Phone:</span></h3>
        ...
        <div className="divItem divItem-faq">
            <h3 className="h3head">
